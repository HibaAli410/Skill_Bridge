...
<div  class="flex justify-center py-4  flex-wrap ">
    <div class="container inline-flex  h-50 px-4 rounded-lg pt-12">
        ...
        <h2 class="mb-3 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Benefits</h2>
...
<div class="grid grid-cols-3 gap-4">
  <div class="flex">
      <div class="rounded-lg bg-home" id="about" role="tabpanel" aria-labelledby="about-tab">
            ...
            <div class="block p-2">
              <h6 class=" text-xl text-third_font_co font-bold tracking-tight p-2 pl-8 pb-0 ">Flexible Learning Schedule</h6>
            </div>
            <div class="block p-2">
              <p class="mb-3 p-0 pl-8 text-gray-500  leading-3 tracking-tight w-100 h-20 leading-6">Fit your coursework around your existing commitments and obligations.</p>
            </div>
            <div class="block p-2">
              <div class="">
